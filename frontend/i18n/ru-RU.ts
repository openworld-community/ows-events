...
export default {
	...
	limitation_of_liability: {
		...
		p_8: 'Отсутствие гарантий означает, что Афиша не принимает на себя никаких обязательств и не несёт ответственность перед пользователями Сервиса или третьими лицами в связи с контентом, размещаемом на Сервисе.'
	},
	meta: {
