...
export default {
	...
	create_title: 'А еще ты можешь сам создать мероприятие и объеденить людей вокруг него.',
	click_button: 'Просто нажмите на кнопку:',
	button: 'в личном кабинете',
	button_circle: 'на главной',
	price: {
		free: 'Бесплатно',
