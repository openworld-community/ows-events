...
export const defaultTranslation = {
  ...
  about: {
    title: 'О нас',
    p1: 'Идея проекта "Афиши" - создать удобную площадку для поиска мероприятий, которые проходят в интересующем пользователя регионе. Пока что будут только IT-мероприятия, но в будущем мы хотим добавлять все: от конференций до музыкальных вечеров.',
