...
export const defaultTranslation = {
	...
	about: {
		...
		functionality:
			'Благодаря нашей платформе вы можете ознакомиться с основной информацией о мероприятии: дате начала и окончания, локации, описании и цене. Пользователь сможет записаться на мероприятие и добавить его в избранное, а организатор мероприятия уже сейчас может добавлять информацию о нем на площадку.',
		monetization:
			'В будущем на платформе появится строго модерируемая реклама и возможность оплачивать билеты, не выходя из Афиши.',
